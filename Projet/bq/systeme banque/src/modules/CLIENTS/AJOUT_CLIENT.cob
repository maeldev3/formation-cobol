       ...
       01 ENR-CLIENT.
          ...
          05 TEL-CLI         PIC X(10).
          05 FILLER          PIC X(1).
          05 REVENU-CLI      PIC 9(7)V99.
          05 FILLER          PIC X(1).
          05 DATE-OUV-CLI    PIC X(10).
      ...
      *> Ajouter client
           ...
           MOVE WS-NEW-REVENU TO REVENU-CLI
           MOVE WS-NEW-DATE TO DATE-OUV-CLI
           ...
           DISPLAY "TEL     : " WS-NEW-TEL
           DISPLAY "REVENU  : " WS-NEW-REVENU " €"
